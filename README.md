...
<p align="center">
  <a href="https://github.com/smwbev/orca-russian/releases"><img src="https://img.shields.io/badge/version-5.1.99-08C?style=flat" alt="Package version 5.1.99" /></a>
...
2. Paste the repository URL **with an explicit `#ref`** — Orca refuses the install without one, so that every install is pinned:
   ...
   ```
   https://github.com/smwbev/orca-russian.git#v5.1.99
   ```
