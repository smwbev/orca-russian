...
<p align="center">
  <a href="https://github.com/smwbev/orca-russian/releases"><img src="https://img.shields.io/badge/version-5.1.10-08C?style=flat" alt="Package version 5.1.10" /></a>
  <img src="https://img.shields.io/badge/coverage-98.5%25-08C?style=flat" alt="98.5 percent of the interface catalog translated" />
  <img src="https://img.shields.io/badge/strings-11%20943-08C?style=flat" alt="11,943 translated strings" />
...
<p align="center">
  ...
  11,943 strings — menus, settings, terminal, editor, GitHub, GitLab, Linear, Jira, mobile, and onboarding.
</p>
...
2. Paste the repository URL **with an explicit `#ref`** — Orca refuses the install without one, so that every install is pinned:
   ...
   ```
   https://github.com/smwbev/orca-russian.git#v5.1.10
   ```
...
locales/ru-RU.json      translation catalog, 11,943 strings
