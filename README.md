...
<p align="center">
  <a href="https://github.com/smwbev/orca-russian/releases"><img src="https://img.shields.io/badge/version-5.1.4-08C?style=flat" alt="Package version 5.1.4" /></a>
  <img src="https://img.shields.io/badge/coverage-98.5%25-08C?style=flat" alt="98.5 percent of the interface catalog translated" />
  <img src="https://img.shields.io/badge/strings-11%20819-08C?style=flat" alt="11,819 translated strings" />
...
<p align="center">
  ...
  11,819 strings — menus, settings, terminal, editor, GitHub, GitLab, Linear, Jira, mobile, and onboarding.
</p>
...
2. Paste the repository URL **with an explicit `#ref`** — Orca refuses the install without one, so that every install is pinned:
   ...
   ```
   https://github.com/smwbev/orca-russian.git#v5.1.4
   ```
...
183 strings cannot be translated. This is an Orca constraint, not missing work:
...
The list keeps shrinking, and both times because Orca merged a fix we sent:
...
- **34 more** left it in [PR #12455](https://github.com/stablyai/orca/pull/12455), which narrowed the plugin namespace rule: section titles, empty states, `Refresh` and the local development form carry no trust decision, so packs may translate them now. Translated since v5.1.4.
...
locales/ru-RU.json      translation catalog, 11,819 strings
