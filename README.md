...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/strings-13%20720-08C?style=flat" alt="13,720 translated strings" />
...
<p align="center">
  ...
  13,720 strings — menus, settings, terminal, editor, GitHub, GitLab, Linear, Jira, mobile, and onboarding.
</p>
...
2. Paste the repository URL **with an explicit `#ref`** — Orca refuses the install without one, so that every install is pinned:
   ...
   ```
   https://github.com/smwbev/orca-russian.git#v5.1.117
   ```
...
locales/ru-RU.json      translation catalog, 13,720 strings
