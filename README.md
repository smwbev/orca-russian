...
<p align="center">
  <a href="https://github.com/smwbev/orca-russian/releases"><img src="https://img.shields.io/badge/version-5.1.145-08C?style=flat" alt="Package version 5.1.145" /></a>
  <img src="https://img.shields.io/badge/coverage-99.1%25-08C?style=flat" alt="99.1 percent of the interface catalog translated" />
  <img src="https://img.shields.io/badge/strings-13%20963-08C?style=flat" alt="13,963 translated strings" />
...
<p align="center">
  ...
  13,963 strings — menus, settings, terminal, editor, GitHub, GitLab, Linear, Jira, mobile, and onboarding.
</p>
...
2. Paste the repository URL **with an explicit `#ref`** — Orca refuses the install without one, so that every install is pinned:
   ...
   ```
   https://github.com/smwbev/orca-russian.git#v5.1.145
   ```
...
locales/ru-RU.json      translation catalog, 13,963 strings
