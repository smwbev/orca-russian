...
<p align="center">
  <a href="https://github.com/smwbev/orca-russian/releases"><img src="https://img.shields.io/badge/version-5.1.50-08C?style=flat" alt="Package version 5.1.50" /></a>
  <img src="https://img.shields.io/badge/coverage-98.5%25-08C?style=flat" alt="98.5 percent of the interface catalog translated" />
  <img src="https://img.shields.io/badge/strings-12%20631-08C?style=flat" alt="12,631 translated strings" />
...
<p align="center">
  ...
  12,631 strings — menus, settings, terminal, editor, GitHub, GitLab, Linear, Jira, mobile, and onboarding.
</p>
...
2. Paste the repository URL **with an explicit `#ref`** — Orca refuses the install without one, so that every install is pinned:
   ...
   ```
   https://github.com/smwbev/orca-russian.git#v5.1.50
   ```
...
locales/ru-RU.json      translation catalog, 12,631 strings
