...
<p align="center">
  <a href="https://github.com/smwbev/orca-russian/releases"><img src="https://img.shields.io/badge/version-5.1.109-08C?style=flat" alt="Package version 5.1.109" /></a>
  <img src="https://img.shields.io/badge/coverage-99.3%25-08C?style=flat" alt="99.3 percent of the interface catalog translated" />
  <img src="https://img.shields.io/badge/strings-13%20514-08C?style=flat" alt="13,514 translated strings" />
...
<p align="center">
  ...
  13,514 strings — menus, settings, terminal, editor, GitHub, GitLab, Linear, Jira, mobile, and onboarding.
</p>
...
2. Paste the repository URL **with an explicit `#ref`** — Orca refuses the install without one, so that every install is pinned:
   ...
   ```
   https://github.com/smwbev/orca-russian.git#v5.1.109
   ```
...
locales/ru-RU.json      translation catalog, 13,514 strings
