...
<p align="center">
  <a href="https://github.com/smwbev/orca-russian/releases"><img src="https://img.shields.io/badge/версия-5.1.4-08C?style=flat" alt="Версия пакета 5.1.4" /></a>
  <img src="https://img.shields.io/badge/покрытие-98.5%25-08C?style=flat" alt="Переведено 98,5 % каталога интерфейса" />
  <img src="https://img.shields.io/badge/строк-11%20819-08C?style=flat" alt="11 819 переведённых строк" />
...
<p align="center">
  ...
  11 819 строк — меню, настройки, терминал, редактор, GitHub, GitLab, Linear, Jira, мобильный режим и онбординг.
</p>
...
> Названия внутри раздела плагинов приведены по-английски намеренно. С версии пакета 5.1.4 обвязка этого раздела переводится — но только в сборках Orca, куда вошёл [наш PR #12455](https://github.com/stablyai/orca/pull/12455). В более старых сборках раздел останется английским целиком. Подробнее — [ниже](#почему-часть-строк-остаётся-английской).
...
183 строки перевести невозможно — это ограничение самой Orca, а не пробел в работе:
...
Список продолжает сокращаться, и оба раза потому, что Orca приняла нашу правку:
...
- **ещё 34** — в [PR #12455](https://github.com/stablyai/orca/pull/12455), который сузил правило защиты: заголовки разделов, пустые состояния, «Обновить» и форма локальной разработки не несут решения о доверии, поэтому пакеты теперь могут их переводить. Переведены начиная с v5.1.4.
...
locales/ru-RU.json      каталог переводов, 11 819 строк
...
|---|---|---|
| Узлов в каталоге | 20 000 | 13 239 |
