...
<p align="center">
  <a href="https://github.com/smwbev/orca-russian/releases"><img src="https://img.shields.io/badge/версия-5.1.10-08C?style=flat" alt="Версия пакета 5.1.10" /></a>
  <img src="https://img.shields.io/badge/покрытие-98.5%25-08C?style=flat" alt="Переведено 98,5 % каталога интерфейса" />
  <img src="https://img.shields.io/badge/строк-11%20943-08C?style=flat" alt="11 943 переведённых строки" />
...
<p align="center">
  ...
  11 943 строки — меню, настройки, терминал, редактор, GitHub, GitLab, Linear, Jira, мобильный режим и онбординг.
</p>
...
locales/ru-RU.json      каталог переводов, 11 943 строки
...
|---|---|---|
| Узлов в каталоге | 20 000 | 13 384 |
