...
<p align="center">
  <a href="https://github.com/smwbev/orca-russian/releases"><img src="https://img.shields.io/badge/версия-5.1.145-08C?style=flat" alt="Версия пакета 5.1.145" /></a>
  <img src="https://img.shields.io/badge/покрытие-99.1%25-08C?style=flat" alt="Переведено 99,1 % каталога интерфейса" />
  <img src="https://img.shields.io/badge/строк-13%20963-08C?style=flat" alt="13 963 переведённые строки" />
...
<p align="center">
  ...
  13 963 строки — меню, настройки, терминал, редактор, GitHub, GitLab, Linear, Jira, мобильный режим и онбординг.
</p>
...
316 ключей каталога остаются английскими, и ни один из них не пробел в работе:
...
- **123 ключа** — осиротели: 111 остались после отката и повторного выпуска обмена навыками, ещё 12 — от настроек SSH-маршрутизации браузера и автоматизаций, переписанных на месте. Их не читает ни один компонент, перевод только утяжелил бы пакет.
- **10 строк** — по-русски выглядят так же (`SHA-256`, `· SSH`, `WSL ·`, образец ссылки, `{{name}} +{{count}}`) либо разбиты на фрагменты, к которым компонент сам приклеивает английское окончание `s`.
...
locales/ru-RU.json      каталог переводов, 13 963 строки
