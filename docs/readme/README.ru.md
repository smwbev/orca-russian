...
<p align="center">
  <a href="https://github.com/smwbev/orca-russian/releases"><img src="https://img.shields.io/badge/версия-5.1.106-08C?style=flat" alt="Версия пакета 5.1.106" /></a>
  <img src="https://img.shields.io/badge/покрытие-99.3%25-08C?style=flat" alt="Переведено 99,3 % каталога интерфейса" />
  <img src="https://img.shields.io/badge/строк-13%20424-08C?style=flat" alt="13 424 переведённых строки" />
...
<p align="center">
  ...
  13 424 строки — меню, настройки, терминал, редактор, GitHub, GitLab, Linear, Jira, мобильный режим и онбординг.
</p>
...
303 ключа каталога остаются английскими, и ни один из них не пробел в работе:
...
- **112 ключей** — осиротели в английском каталоге после того, как обмен навыками откатили и выпустили заново: их не читает ни один компонент, перевод только утяжелил бы пакет.
- **8 строк** — по-русски выглядят так же (`SHA-256`, `· SSH`, `WSL ·`, образец ссылки, `{{name}} +{{count}}`) либо разбиты на фрагменты, к которым компонент сам приклеивает английское окончание `s`.
...
locales/ru-RU.json      каталог переводов, 13 424 строки
