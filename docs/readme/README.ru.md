...
<p align="center">
  <a href="https://github.com/smwbev/orca-russian/releases"><img src="https://img.shields.io/badge/версия-5.1.63-08C?style=flat" alt="Версия пакета 5.1.63" /></a>
  <img src="https://img.shields.io/badge/покрытие-99.3%25-08C?style=flat" alt="Переведено 99,3 % каталога интерфейса" />
  <img src="https://img.shields.io/badge/строк-12%20948-08C?style=flat" alt="12 948 переведённых строк" />
...
<p align="center">
  ...
  12 948 строк — меню, настройки, терминал, редактор, GitHub, GitLab, Linear, Jira, мобильный режим и онбординг.
</p>
...
locales/ru-RU.json      каталог переводов, 12 948 строк
